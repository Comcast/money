 ...
 * this is used in the [[com.comcast.money.akka.http.server.MoneyTrace]] [[akka.http.scaladsl.server.Directive]]
 *
 ...
 * [[HttpRequestSpanKeyCreator]] present when a [[com.comcast.money.akka.http.server.MoneyTrace]] Directive is created
 *
 */
